...
yum -y update
yum -y install nano wget curl net-tools lsof bzip2 zip unzip epel-release git sudo make cmake GeoIP sed at ant iotop hdparm 
#yum -y install rar unrar lsblk awk
