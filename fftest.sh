...
http://download.videolan.org/pub/contrib/lame/lame-3.100.tar.gz
# http://downloads.sourceforge.net/project/lame/lame/3.99/lame-3.99.5.tar.gz

https://github.com/xiph/opus/archive/v1.3.tar.gz
https://github.com/webmproject/libvpx/archive/v1.8.0.tar.gz
https://rtmpdump.mplayerhq.hu/download/rtmpdump-2.3.tgz
...
https://github.com/uclouvain/openjpeg/releases/download/v2.3.0/openjpeg-v2.3.0-linux-x86_64.tar.gz
...
https://github.com/xiph/speex/archive/Speex-1.2.0.tar.gz
