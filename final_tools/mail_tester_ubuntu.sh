...
hostnamectl set-hostname host.fastserver.me

echo ""
echo "SETUP Configured Successfully..."
echo ""
echo ""
echo "if need to change hostname, run: hostnamectl set-hostname host.fastserver.me "
echo "set A record"
echo "set SPF record"
echo "set reverse IP Host at Network"
echo ""
echo " Then visit http://test16.fastserver.me/PHPMailer/src/test.php "
echo ""
